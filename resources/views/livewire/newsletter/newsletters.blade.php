                                ...
                                <th scope="row">
                                    <div class="media align-items-center">
                                        <div class="media-body">
                                            <span class="name mb-0 text-sm mr-2">{{$newsletter->title}}</span>
                                        </div>
                                    </div>
                                </th>
                                <th scope="row">
                                    <div class="media align-items-center">
                                        <div class="media-body">
                                            <span class="name mb-0 text-sm mr-2">{{$newsletter->body}}</span>
                                        </div>
                                    </div>
                                </th>
                                <td class="text-right">
                                    <a rel="tooltip" class="btn btn-danger btn-icon btn-sm text-white" data-original-title="حذف" title="" name="deletequestion" @click="id = !id" wire:click="deleteConfirmed({{$newsletter->id}})">
