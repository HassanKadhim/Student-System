...
<div class="nav-wrapper">
    <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
        <li class="nav-item">
            <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-tabs-stages-tab" data-toggle="tab" href="#tabs-tabs-stages" role="tab" aria-controls="tabs-tabs-stages" aria-selected="true"><i class="fas fa-table ml-2"></i>الامتحانات</a>
        </li>
