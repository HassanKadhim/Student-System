...
<div class="nav-wrapper">
    <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-subjects" role="tablist">
        <li class="nav-item">
            <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-subjects" data-toggle="tab" href="#tabs-subjects" role="tab" aria-controls="tabs-subjects" aria-selected="true"><i class="ni ni-cloud-upload-96 ml-2"></i>الغيابات</a>
        </li>
